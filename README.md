...
*Disclaimer: This article was created based on videos from [sentdex](https://www.youtube.com/watch?v=Wo5dMEP_BbI&list=PLQVvvaa0QuDcjD5BAw2DxE6OF2tius3V3) on YouTube!*

| Title                            | Extension | Size   | Language | Last update |
|----------------------------------|-----------|--------| -------- | ------------|
| [Redes Neurais Artificiais - PTBR](https://github.com/Gustavo2022003/neural_networks/blob/master/docs/Articles/pt-br/Redes%20Neurais%20Artificiais%20-%20ptBR.pdf) | pdf       | {{ file_size }} | Portguese 🇧🇷 | {{ last_update }} |
